...
import com.E22214005_SHY.StudentSystem.bean.Student;
import com.E22214005_SHY.StudentSystem.dao.ManageHelper;
import com.E22214005_SHY.StudentSystem.model.StudentModel;
...
public class ModifyFrame extends JDialog{
	...
	public ModifyFrame(JDialog owner, String title, boolean modal,int rowNum,StudentModel sm){
		...
		student_IDText.setText(student_id);	//获学班号并显示
		...
		modify_Button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//数据校验部分
				if(id.equals("")){
					JOptionPane.showMessageDialog(jd, "学号不能为空！", "", JOptionPane.WARNING_MESSAGE);
					return ;
				}
				if(name.equals("")){
